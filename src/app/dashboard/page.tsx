      ...
      <section className="space-y-6">
        <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-sm font-medium uppercase tracking-[0.24em] text-slate-500">Chart lesson</p>
              <h1 className="mt-2 text-3xl font-semibold text-slate-950">Dashboard</h1>
            </div>
            <div className="rounded-full bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm">Step 1 of 1 • BTC daily volume</div>
          </div>
        ...
        <CandleChart candles={question.candles} selectedIndex={selectedIndex} onSelectCandle={handleSelect} />
      </section>
